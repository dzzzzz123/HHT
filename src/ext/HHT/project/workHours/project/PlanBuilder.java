...
@TypeBased(value = "com.ptc.projectmanagement.plan.Plan")
@ComponentBuilder(value = ComponentId.INFOPAGE_ID)
public class PlanBuilder extends AbstractInfoConfigBuilder implements ComponentDataBuilder {
	...
	protected InfoConfig buildInfoConfig(ComponentParams arg0) throws WTException {
		...
		result.setTabSet("CustomPlanInfoPageTabSet");
		return result;
	}
