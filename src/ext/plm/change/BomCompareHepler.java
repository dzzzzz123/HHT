...
public class BomCompareHepler {
	...
	private static List<CompareMessage> getCompareMessage( WTPart parentPart1 , WTPart parentPart2 ) {
		...
		String version1 = parentPart1.getVersionIdentifier().getValue() + "." + parentPart1.getIterationIdentifier().getValue();
		String version2 = parentPart2.getVersionIdentifier().getValue() + "." + parentPart2.getIterationIdentifier().getValue();
		//0、更改物料
