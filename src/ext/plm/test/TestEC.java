...
public class TestEC implements RemoteAccess {
	...
	public static void main( String[] args ) throws WTException {
		...
		System.out.println("start to test----1--------"+(new Date()).toLocaleString());
		System.out.println("-------arg:"+args[2]);
		createECA(args[2]);
		
		System.out.println("end test---1-------"+(new Date()).toLocaleString());
	}
	
	public static void createECA(String id){
		if (!RemoteMethodServer.ServerFlag) {	
			String CLASSNAME = (TestEC.class).getName();
