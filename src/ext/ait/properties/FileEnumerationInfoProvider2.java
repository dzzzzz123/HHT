...
public class FileEnumerationInfoProvider2 implements EnumerationInfoProvider {
	private static PropertiesUtil pUtil = PropertiesUtil.getInstance("customEnum.properties");
	private static final String ENUMERATION_NAME = "SupplierMasterData";
	...
	public FileEnumerationInfoProvider2() {
	}
