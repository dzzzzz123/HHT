...
public class Config {
	...
	public static String getHHT_PDOwnership(WTPart part) {
	...
	public static HashMap<String, String> getSAPState() {
		HashMap<String, String> result = new HashMap<>();
		String statePatternStr = properties.getValueByKey("SAP.state");
		String[] statePatterns = statePatternStr.split("/");
		for (String str : statePatterns) {
			String[] pattern = str.split(":");
			result.put(pattern[0], pattern[1]);
		}
		return result;
	}
