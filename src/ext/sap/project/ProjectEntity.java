...
public class ProjectEntity {
    ...
    public ProjectEntity(String projectNumber, String projectName, String projectCategory, String projectOwner,
            String projectCreateStamp, String projectEndStamp, String factoryCode, String deleteFlag,
            String projectDescription, String finishFlag) {
    ...
    public String toString() {
        return "ProjectEntity [ProjectNumber=" + ProjectNumber + ", ProjectName=" + ProjectName + ", ProjectCategory="
                ...
                + ", ProjectEndStamp=" + ProjectEndStamp + ", FactoryCode=" + FactoryCode + ", DeleteFlag=" + DeleteFlag
                + ", ProjectDescription=" + ProjectDescription + ", FinishFlag=" + FinishFlag + "]";
    }
