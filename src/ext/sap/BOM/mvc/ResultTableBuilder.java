...
@ComponentBuilder(value = { "sap.bomResult.list" }, type = ComponentBuilderType.CONFIG_AND_DATA)
	...
	public Object buildComponentData(ComponentConfig config, ComponentParams params) throws Exception {
		...
		if (primaryOid2 != null) {
			...
			if (content instanceof WorkItem) {
				...
				String value = (String) wfProcess.getContext().getValue(Config.getBOMJsonVar());
