...
public class BOMCostBuilder extends AbstractInfoConfigBuilder implements ComponentDataBuilder {
	...
	protected InfoConfig buildInfoConfig(ComponentParams arg0) throws WTException {
		...
		result.setNavBarName("wtpart_customize_menu");
		result.setTabSet("BOMCostInfoPageTabSet");
		return result;
	}
