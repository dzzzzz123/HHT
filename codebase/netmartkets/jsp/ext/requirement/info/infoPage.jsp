...
<html>
  ...
  <body>
      ...
      <div class="layui-col-md9">
        <div class="layui-row grid-demo">
          <div class="layui-col-md3">
            <div class="layui-panel" style="margin-left: 30px">
          ...
          <div class="layui-col-md8">
            <div class="layui-panel" style="margin-left: 30px">
              <label class="exampleInputEmail4" style="font-weight: 900"
                >需求描述：</label
              >
          ...
          <div class="layui-col-md11">
            ...
            >
              <div style="padding: 30px">
                ...
                <label class="hhtcustomerComment" style="font-weight: 900"
                  >客户意见</label
                >
              </div>
            </div>
    ...
    <script
      ...
      src="<%=basePath %>/netmarkets/jsp/ext/requirement/layui-v2.7.6/layui/layui.js"
    ></script>
